...
def iter_minibatches(
    ...
    for i in range(0,N,minibatch_size):
        ...
        minibatch = RolloutBatch(
            ...
            task_names=[batch.task_names[j] for j in idx] if batch.task_names is not None else None,
            completion_texts=[batch.completion_texts[j] for j in idx] if batch.completion_texts is not None else None,
        )
